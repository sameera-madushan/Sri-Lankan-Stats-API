...
class DistrictSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        District::insert([
            ...
            ['id' => 13, 'province_id' => 9, 'district_code_en' => 'KO', 'district_code_si' => 'කිළි', 'district_code_ta' => 'கிளி', 'name_en' => 'Kilinochchi', 'name_si' => 'කිලිනොච්චිය', 'name_ta' => 'கிளிநொச்சி', 'created_at' => $now, 'updated_at' => $now],
